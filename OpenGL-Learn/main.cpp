...
int main()
{
	...
	// VBO = Vertex Buffer Object: a buffer object that allocates memory on the GPU 
	//		 and stores all the vertex data there for the graphics card to use.
	// VAO = Vertex Array Object: stores buffer and vertex attribute state information.
	// EBO = Element Buffer Object: a buffer object that stores indices on the GPU for indexed drawing.
